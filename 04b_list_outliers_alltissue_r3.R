...
gene_tpm_outlier_pc_fn = paste0(data_dir, '/20170901.gene.sample.outlier.pc.values.r3.alltissue.txt')
iso_tpm_outlier_pc_fn = paste0(data_dir, '/20170901.isoform.sample.outlier.pc.values.r3.alltissue.txt')
iso_pct_outlier_pc_fn = paste0(data_dir, '/20170901.isoform.percentage.sample.outlier.pc.values.r3.alltissue.txt')
prev_outlier_fn = paste0(data_dir, '/20170901.outlier_samples_alltissue_r2.txt')
outlier_out_fn = paste0(data_dir, '/20170901.outlier_samples_alltissue_r3.txt')
...
isofpct.pc.outliers <- rownames(isofpct.vals)[c(
  which(isofpct.vals$BRNACC.PC4 < -0.3),
