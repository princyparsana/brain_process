...
brainExpr <- read.table('20170517.gtex_expression.isoform.brain.good_genes.outlier_rm.txt', header=T)
...
write.table(tissue.hcp, file='20170517.gtex_expression.isoform.brain.good_genes.outlier_rm.HCP.txt', quote=F, sep='\t')
