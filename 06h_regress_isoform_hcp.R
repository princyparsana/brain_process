...
brainExpr <- read.table('20170517.gtex_expression.alltissue.isoform.good_genes.outlier_rm.txt', header=T)
...
write.table(tissue.hcp, file='20170517.gtex_expression.alltissue.isoform.good_genes.outlier_rm.HCP.txt', quote=F, sep='\t')
