...
getArgs <- function() {
  parser <- ArgumentParser(description='EarthSelect for covariates')
  parser$add_argument('expression', help='The expression file', type='character', default=NULL)
  parser$add_argument('covariates', help='The covariate file', type='character', default=NULL)
  parser$add_argument('output', help='The output file', type='character', default=NULL)
  parser$add_argument('--replicates', help='Number of replicates', type='integer', default=50)
  parser$add_argument('--ncores', help='Number of cores', type='integer', default=1)
  parser$add_argument('--log', help='Take log2(1e-3 + x) of expression if set to 1', type='integer', default=0)
  parser$add_argument('--regress', help='Regress this covariate out of the others prior to selection; comma for multiple', type='character', default=NULL)
  parser$add_argument('--jackknife', help='Downsample to this many samples', type='integer', default=0)
  parser$add_argument('--within', help='Run within groups (one per replicate)', type='character', default=NULL)
