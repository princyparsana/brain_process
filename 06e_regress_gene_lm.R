...
brainExpr <- read.table('20170517.gtex_expression.alltissue.good_genes.outlier_rm.txt', header=T, sep='\t')
...
write.table(brainExpr.reg, quote=F, sep='\t', file='20170517.gtex_expression.alltissue.good_genes.outlier_rm.lm_regressed.txt')
